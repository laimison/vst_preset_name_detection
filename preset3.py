...
# it should extract "BASS - Dope Reese"
...
img = cv2.imread('img/preset3.png', cv2.IMREAD_COLOR)
...
text = pytesseract.image_to_string(Image.open('img/preset3.png')) # preset3 works!
